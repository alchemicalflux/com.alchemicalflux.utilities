/*------------------------------------------------------------------------------
File:       ColorLinearLerpImplTests.cs 
Project:    AlchemicalFlux Utilities
Overview:   Provides unit tests for the ColorLinearLerpImpl class, which 
            performs linear interpolation (lerp) between two Color values. This 
...
{
    /// <summary>
    /// Unit tests for the <see cref="ColorLinearLerpImpl"/> class.
    /// </summary>
    public class ColorLinearLerpImplTests : TwoPointColorInterpolatorTests
    {
        ...
        /// </summary>
        static ColorLinearLerpImplTests()
        {
        ...
        public override void Setup()
        {
            TwoPointInterpolator =
                new ColorLinearLerpImpl(_startColor, _endColor);
        }
        ...
        {
            var interpolator = new ColorLinearLerpImpl(_startColor, _endColor);
