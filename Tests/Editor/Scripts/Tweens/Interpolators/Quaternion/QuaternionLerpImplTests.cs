/*------------------------------------------------------------------------------
File:       QuaternionLerpImplTests.cs 
Project:    AlchemicalFlux Utilities
Overview:   Unit tests for the QuaternionLerpImpl class, which performs linear
...
{
    /// <summary>
    /// Unit tests for the <see cref="QuaternionLerpImpl"/> class.
    /// </summary>
    public sealed class QuaternionLerpImplTests
        : TwoPointQuaternionInterpolatorTests
    {
        ...
        public override void Setup()
        {
            TwoPointInterpolator =
                new QuaternionLerpImpl(_startQuaternion, _endQuaternion);
        }
