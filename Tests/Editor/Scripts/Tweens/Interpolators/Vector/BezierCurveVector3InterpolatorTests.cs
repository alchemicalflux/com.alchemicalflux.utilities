...
Overview:   Abstract base class for unit tests of
            BezierCurveInterpolator<Vector3>. Provides a foundation for testing
            Vector3 interpolation logic using Bezier curves.
...
namespace AlchemicalFlux.Utilities.Tweens.Tests
{
    ...
    /// <see cref="BezierCurveInterpolator{TType}"/> with <see cref="Vector3"/>.
    /// </summary>
    public abstract class BezierCurveVector3InterpolatorTests
        : BezierCurveInterpolatorTests<Vector3>
    {
        /// <summary>
        /// A <see cref="Vector3"/> value representing NaN (Not a Number) for
        /// invalid test cases.
        /// </summary>
