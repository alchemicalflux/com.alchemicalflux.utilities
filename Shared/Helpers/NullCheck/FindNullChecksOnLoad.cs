...
namespace AlchemicalFlux.Utilities.Helpers
{
    ...
    /// <summary>
    /// Initializes and executes a search for null check violations upon the
    /// launch of the Unity Editor.
    /// </summary>
    [InitializeOnLoad]
    public class FindNullChecksOnLoad
    {
        ...
        /// <summary>
        /// Static constructor. Initializes the class and schedules a one-time
        /// search for null check violations upon the launch of the Unity Editor 
        /// in debug builds.
        /// </summary>
        static FindNullChecksOnLoad()
        {
            ...
            // Schedule a one-time search for null check violations upon the
            // first launch of the editor.
        ...
        /// <summary>
        /// Executes a one-time search for null check violations within scene 
        /// objects and assets.
        /// </summary>
        private static void CheckOnStart()
        {
            ...
            // Being in play mode means only the assets and current scene can
            // be proecessed.
            var foundErrors = 
        ...
        /// <summary>
        /// Checks for null check violations upon exiting edit mode and stops 
        /// play mode if any are found.
        /// </summary>
        /// <param name="stateChange">
        /// The state change event triggered upon exiting edit mode.
        /// </param>
        /*
        private static void CheckOnExitingEditMode(
        PlayModeStateChange stateChange)
        {
            if(stateChange != PlayModeStateChange.ExitingEditMode) { return; }

            // Unity is still in edit mode, so assets and all scenes can be
            // processed.
            var foundErrors = 
                NullCheckProcessing.ProcessGameObjectsInAssetDatabase();
