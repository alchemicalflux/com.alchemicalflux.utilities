...
{
    /// <summary>
    /// Contains the necessary data for tracking changes made to a list view 
    /// element.
    /// </summary>
    public class FolderData : ScriptableObject
    {
        ...
        /// <summary>
        /// Flag indicating if the PreCommits should be processed.
        /// </summary>
        public bool IncludePreCommits;

        /// <summary>
        /// Flag indicating if the Semantic Release should be processed.
        /// </summary>
